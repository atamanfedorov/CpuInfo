...
import rus.cpuinfo.Model.HardwareInfo;
...
public class HardwareAdapterProvider {
    ...
    {
        // According to a position on a RecyclerView
    ...
    {
        return Collections.nCopies(Runtime.getRuntime().availableProcessors(), HardwareInfo.CPU_FREQ);
    }
